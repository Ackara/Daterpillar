...
(
	[Id] INTEGER NOT NULL,
	[name_of_card] VARCHAR(256) NOT NULL,
	[Text] TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS [card_name_of_card] ON [card] ([name_of_card] ASC);

INSERT INTO [card] ([Id], [name_of_card], [Text], [Pendulum_Effect], [Level], [Atk], [Def], [Card_Type_Id], [Attribute_Id], [Card_Icon_Id], [Monster_Type_Id], [Ability_Id]) SELECT [Id], [Name], [Text], [Pendulum_Effect], [Level], [Atk], [Def], [Card_Type_Id], [Attribute_Id], [Card_Icon_Id], [Monster_Type_Id], [Ability_Id] FROM [card_temp_table];
