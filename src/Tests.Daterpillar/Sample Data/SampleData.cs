namespace Tests.Daterpillar
{
	public static partial class SampleData
	{
		...
		public const string SongsCSV = @"Sample Data\songs.csv";
		...
		public const string DataConnStr = "|DataDirectory|\\data.xlsx";
		public const string SongsConnStr = "|DataDirectory|\\songs.csv";
